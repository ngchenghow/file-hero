...
电脑版和手机版存入视频时，都会在视频所在的文件夹里建立 `thumbs` 文件夹，为每个视频截 3 张 250×250 的 JPEG（在视频 25%、50%、75% 处，整个画面等比缩放，空白处为黑色），并在 `file-readme.txt` 里该视频的记录中写上截图位置：
...
- 已在 SSD 上但还没有截图的视频，在电脑版点「更新说明」，或在手机版文件夹路径旁点「生成视频截图」图标，即可补齐当前文件夹及子文件夹；缺了某张截图的视频也会重新截图。
